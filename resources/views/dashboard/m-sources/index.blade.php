...
<body>
    ...
    <div class="topnav">
        <a class="active" href="{{ route('showmainSources') }}">main sources</a>
    ...
    <section>
        <div class="tbl-header">
            <table cellpadding="0" cellspacing="0" border="0">
                <thead>
                    <tr>
                        <th><a href="{{ route('showCreatepagemainSources') }}">create</a></th>
                        <th>name</th>
                        <th>description</th>
                        <th>logo_url</th>
                        <th>edit</th>
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>{{ $item->logo_url }}</td>
                            <td><a href="{{ route('showEditepagemainSources', $item->id) }}">Edit</a></td>
                            <form method="POST" action="{{ route('DeletemainSources', $item->id) }}">
                                @csrf
