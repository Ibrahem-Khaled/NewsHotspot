...
<body>
    ...
    <div class="topnav">
        ...
        <a class="active" href="{{ route('showcategories') }}">category</a>
        ...
        <section>
            <div class="tbl-header">
                <table cellpadding="0" cellspacing="0" border="0">
                    <thead>
                        <tr>
                            <th><a href="{{ route('showCreatepagecategories') }}">create</a></th>
                            <th>name</th>
                            <th>description</th>
                            <th>edit</th>
                            <th>delete</th>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td><a href="{{ route('showEditepagecategories', $item->id) }}">Edit</a></td>
                                <form method="POST" action="{{ route('Deletecategories', $item->id) }}">
                                    @csrf
